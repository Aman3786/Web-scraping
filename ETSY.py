...
for pages in range(25,0,-1):
    images = []
    Title = []
    #os.mkdir(f'C:\\Users\\mustafa\\Desktop\\Ceopa\\link1\\page{x}')
    #os.chdir(f'C:\\Users\\mustafa\\Desktop\\Ceopa\\link1\\page{x}')
    print(f"page = {pages}")
    print()
...
#https://www.etsy.com/uk/shop/LeahCaylorFineArt?section_id=23778381
    ...
    for number,link in enumerate(links):
        ...
        #os.mkdir(f'C:\\Users\\mustafa\\Desktop\\Ceopa\\link1\\page{x}\\product{y}')
        #os.chdir(f'C:\\Users\\mustafa\\Desktop\\Ceopa\\link1\\page{x}\\product{y}')
