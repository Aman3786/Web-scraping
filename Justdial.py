...
#pages
#General_store = [1,12,20,25,31,38,45,49]
#software_company = [1,12,15,20,25,31,33]
#shopping_centres = [1]
#shopping_mall = [1,3,4,5]
#Restaurants = [1,12,25,38,45,49]
#property_sales = [1,12,16,20,29,31,38,45]
#House_rent = [1,5,12,16,20,23]
#Real_estate = [1,12,25,31,38,45,49]
#Hotels = [1,12,16,22,30,36,41]
#Dentists = [1,10,16,22,30,33,36,41]
